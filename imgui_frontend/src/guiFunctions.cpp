...
const char *biasGenHeaderStr[BIASGEN_CATEGORIES] = {"Alpha DPI", "Neurons", "Analog Synapses", "Digital Synapses", "Synapse Pulse Extension", "Learning Block / Stop Learning Block", "Current To Frequency", "Buffers"};
#endif
